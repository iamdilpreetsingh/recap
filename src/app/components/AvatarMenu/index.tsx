    ...
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-48 bg-white border border-neutral-200 rounded-2xl shadow-sm p-2 z-20">
          <button
            onClick={signOut}
            className="w-full text-left px-3 py-2 rounded-lg bg-neutral-100 text-sm font-medium text-neutral-700 hover:bg-neutral-200 transition-colors cursor-pointer"
          >
            Logout
          </button>
        </div>
